        ...
        builder: (controller) {
          ...
          return HandlingDataView(
            ...
            widget: ListView.builder(
              ...
              itemCount: controller.listTerms.length, // عدد العناصر
              itemBuilder: (context, index) {
                return Column(
                  children: [
                    HeaderHomeTitle(
                      textTile: translateDataBase(
                          controller.listTerms[index].titleEn,
                          controller.listTerms[index].titleAr), // جلب العنوان
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            initialValue: translateDataBase(
                                    controller.listTerms[index].contentEn,
                                    controller.listTerms[index].contentAr) ??
                                "",
                            maxLines: null,
