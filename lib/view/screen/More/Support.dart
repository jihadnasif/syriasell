        ...
        builder: (controller) {
          ...
          return HandlingDataView(
            ...
            widget: ListView.builder(
              ...
              itemCount: controller.listSupport.length, // عدد العناصر
              itemBuilder: (context, index) {
                return Column(
                  children: [
                    HeaderHomeTitle(
                      textTile: translateDataBase(
                          controller.listSupport[index].titleEn,
                          controller.listSupport[index].titleAr), // جلب العنوان
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            initialValue: translateDataBase(
                                    controller.listSupport[index].contentEn,
                                    controller.listSupport[index].contentAr) ??
                                "",
                            maxLines: null,
