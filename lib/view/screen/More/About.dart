...
import 'package:syria_sell/view/widget/Beginning/LogoOnly.dart';
...
import '../../widget/Home/HeaderHomeTitle.dart';
        ...
        builder: (controller) {
          ...
          return HandlingDataView(
            ...
            widget: ListView.builder(
              ...
              itemCount: controller.listAbout.length, // عدد العناصر
              itemBuilder: (context, index) {
                return Column(
                  children: [
                    HeaderHomeTitle(
                      textTile: translateDataBase(
                          controller.listAbout[index].titleEn,
                          controller.listAbout[index].titleAr), // جلب العنوان
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            initialValue: translateDataBase(
                                    controller.listAbout[index].contentEn,
                                    controller.listAbout[index].contentAr) ??
                                "",
                            maxLines: null,
