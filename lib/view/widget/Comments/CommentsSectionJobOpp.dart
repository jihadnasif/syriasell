...
import 'package:syria_sell/controller/Jobs/ViewJopOpportunityController.dart';

class CommentsSectionJobOpp extends StatelessWidget {
  final int jobId;
  final ViewJopOpportunityControllerImp controller =
      Get.find<ViewJopOpportunityControllerImp>();
  final TextEditingController commentController = TextEditingController();

  CommentsSectionJobOpp({super.key, required this.jobId});
